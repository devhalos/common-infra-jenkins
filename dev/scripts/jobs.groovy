organizationFolder('github-org-pipelines-devhalos') {
    displayName('github-org-pipelines-devhalos')
    description('Github Organization Pipelines - devhalos')
    organizations {
        github {
            repoOwner('devhalos')
            apiUri('https://api.github.com')
            credentialsId('github-credentials-token-devhalos')
            traits {
                gitBranchDiscovery()
                gitHubTagDiscovery()
